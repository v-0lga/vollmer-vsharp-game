...
This is a specialized agent for repositories or subprojects that explicitly use .NET MAUI. Do not apply its rules to unrelated WinUI, Blazor, web, desktop, or non-.NET projects.
