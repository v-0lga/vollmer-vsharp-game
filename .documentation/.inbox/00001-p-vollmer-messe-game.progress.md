...
|-|-|-|-|-|
| AP-01 | Betriebsnachweise für Messeaufbau vorbereiten. | ⬜ offen | | Parallel zu AP-02 bis AP-05: B-01/B-02 als Checkliste vorbereiten; kein Implementierungsschritt ist davon abhängig. |
| AP-02 | Reproduzierbares Projektgerüst und lokalen Offline-Host aufsetzen. | ⬜ offen | | Nächster Umsetzungsschritt: Host und aktiven Client auf demselben Convertible ohne WLAN starten. |
...
| AP-04 | Tap-Laser, Säge-Swipe und humorvolle Retro-Editor-Hülle prototypisch umsetzen. | ⬜ offen | | Nach AP-03: Trefferzonen, Full-HD-Host-/QHD-Watcher-Skalierung und lokalen Kabel-Watcher prüfen. |
...
- 2026-09-23: Offene Konzeptpunkte bereinigt: Hardwareprofil und Assetvertrag sind entschieden. B-01 Hardware-/Audiofunktion und B-02 Produktionsmedien sind Nachweise vor AP-06, keine Gates für die Implementierung. AP-02 startet ohne Abhängigkeit von AP-01.
...
- Exakter nächster Umsetzungsschritt: AP-02 vor Beginn auf `🔄 in Arbeit` setzen und das reproduzierbare Projektgerüst aufbauen. AP-01 läuft bei Bedarf parallel; B-01 und B-02 sind erst vor AP-06 nachzuweisen.
- Keine offenen Konzeptentscheidungen. Vor Messebetrieb stehen B-01 Hardware-/Audiofunktion und B-02 Produktionsmedien aus. Betreiberangaben, zweckbezogene Löschtermine und Teilnahmebedingungen werden im Rahmen der regulären Einrichtung in den konfigurierbaren Hinweis eingesetzt; Kontakt-/Gewinnspielfunktionen und Schutzmaßnahmen sind noch zu implementieren und zu prüfen.
